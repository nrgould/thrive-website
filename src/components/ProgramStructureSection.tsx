					...
					{[
						{
							...
							icon: (
								<Apple className='text-blue-500 w-8 h-8 mb-3' />
							),
						},
						{
							title: 'Move',
							...
							icon: (
								<Activity className='text-blue-500 w-8 h-8 mb-3' />
							),
						},
						{
							title: 'Sleep',
							...
							icon: (
								<Moon className='text-blue-500 w-8 h-8 mb-3' />
							),
						},
						{
							title: 'Release',
							description:
								"Manage stress and let go of what's not serving you",
							icon: (
						...
						},
						{
							...
							icon: (
								<Brain className='text-blue-500 w-8 h-8 mb-3' />
							),
						},
						{
							title: 'Connect',
