				...
				<div className='flex flex-col lg:flex-row items-center gap-12'>
					...
					>
						...
						<p className='text-lg text-slate-700 mb-6 leading-relaxed'>
							...
							physical activity, behavior change, and more.
							We&apos;re committed to supporting you through every
							step of your health transformation journey.
						</p>
						<p className='text-lg text-slate-700 leading-relaxed'>
							With a combined experience of over 100 years in
							healthcare and wellness, we&apos;ve helped hundreds
							of people achieve lasting lifestyle changes and
